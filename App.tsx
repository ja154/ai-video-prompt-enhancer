...
const App = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white p-4 sm:p-8 flex flex-col items-center justify-start font-sans overflow-y-auto">
            <style>
                {`
            ...
            <div className="w-full max-w-4xl bg-gray-800 p-6 sm:p-10 rounded-2xl shadow-2xl border border-gray-700 animate-fade-in">
            ...
            {/* NEW: Prompt Tips Section */}
            <div className="mt-12 max-w-4xl mx-auto bg-gray-800 p-6 rounded-2xl border border-gray-700 shadow-xl animate-fade-in">
                <h2 className="text-2xl sm:text-3xl font-bold text-emerald-400 mb-4">
                    💡 Prompt Tips
                </h2>
                <ul className="list-disc pl-6 space-y-2 text-gray-300">
                    <li>✅ Be specific: Describe subjects and actions clearly.</li>
                    <li>✅ Add style: Cinematic, hyperrealistic, anime.</li>
                    <li>✅ Include lighting: Golden hour, neon, moody.</li>
                    <li>✅ Mention POV: First-person, third-person.</li>
                    <li>✅ Keep it ~8 seconds concept: Dynamic and concise.</li>
                </ul>
            </div>
        </div>
    );
